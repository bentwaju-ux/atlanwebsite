...
const WATCHES = [
  // ---------------- Rolex ----------------
  { id: "rolex-submariner-date-steel-black", image: "assets/watches/rolex-submariner-date-steel-black.svg", brand: "rolex", model: "Submariner Date", reference: "126610LN", material: "steel", dialColor: "black", price: 14500, caseSize: "41mm", description: "The archetypal dive watch, unfussy and permanently in demand." },
  { id: "rolex-submariner-nodate-steel-black", image: "assets/watches/rolex-submariner-nodate-steel-black.svg", brand: "rolex", model: "Submariner", reference: "124060", material: "steel", dialColor: "black", price: 9800, caseSize: "41mm", description: "No-date Submariner — cleaner dial, same 300m capability." },
  { id: "rolex-datejust41-steel-silver", image: "assets/watches/rolex-datejust41-steel-silver.svg", brand: "rolex", model: "Datejust 41", reference: "126334", material: "steel", dialColor: "silver", price: 9200, caseSize: "41mm", description: "The everyday Rolex — fluted bezel, Jubilee bracelet." },
  { id: "rolex-datejust41-twotone-champagne", image: "assets/watches/rolex-datejust41-twotone-champagne.svg", brand: "rolex", model: "Datejust 41", reference: "126333", material: "two-tone", dialColor: "champagne", price: 12800, caseSize: "41mm", description: "Steel and yellow gold with a warm champagne dial." },
  { id: "rolex-daytona-steel-black", image: "assets/watches/rolex-daytona-steel-black.svg", brand: "rolex", model: "Cosmograph Daytona", reference: "126500LN", material: "steel", dialColor: "black", price: 32000, caseSize: "40mm", description: "The most requested chronograph in the world, full stop." },
  { id: "rolex-daytona-yellowgold-black", image: "assets/watches/rolex-daytona-yellowgold-black.svg", brand: "rolex", model: "Cosmograph Daytona", reference: "126508", material: "yellow-gold", dialColor: "black", price: 45000, caseSize: "40mm", description: "Daytona in 18k yellow gold with a black lacquer dial." },
  { id: "rolex-gmt-batman-steel-blue", image: "assets/watches/rolex-gmt-batman-steel-blue.svg", brand: "rolex", model: 'GMT-Master II "Batman"', reference: "126710BLNR", material: "steel", dialColor: "blue", price: 18500, caseSize: "40mm", description: "Blue and black Cerachrom bezel, two time zones on the wrist." },
  { id: "rolex-skydweller-rosegold-brown", image: "assets/watches/rolex-skydweller-rosegold-brown.svg", brand: "rolex", model: "Sky-Dweller", reference: "326135", material: "rose-gold", dialColor: "brown", price: 44000, caseSize: "42mm", description: "Annual calendar and dual time zone, cased in Everose gold." },
